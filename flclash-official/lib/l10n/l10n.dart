...
class AppLocalizations {
  ...
  /// `Line:`
  String get classicLine {
    return Intl.message('Line:', name: 'classicLine', desc: '', args: []);
  }

  /// `Change`
  String get classicChange {
    return Intl.message('Change', name: 'classicChange', desc: '', args: []);
  }

  /// `Google website`
  String get classicGoogle {
    return Intl.message(
      'Google website',
      name: 'classicGoogle',
      desc: '',
  ...
  String get classicPermanent {
    return Intl.message(
      'Get permanent access',
      name: 'classicPermanent',
      desc: '',
      args: [],
    );
  }
  ...
  String get classicPurchaseInfo {
    return Intl.message(
      'This entry is retained for the classic layout. The original purchase service is not connected and no payment will be taken. Import your own subscription in Profiles.',
      name: 'classicPurchaseInfo',
      desc: '',
      args: [],
    );
  }
  ...
  /// `According to rules`
  String get classicRulesLine {
    return Intl.message(
      'According to rules',
      name: 'classicRulesLine',
      desc: '',
      args: [],
    );
  }
