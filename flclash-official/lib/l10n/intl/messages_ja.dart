...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "classicChange": MessageLookupByLibrary.simpleMessage("変更"),
    "classicGoogle": MessageLookupByLibrary.simpleMessage("Google公式サイト"),
    "classicHome": MessageLookupByLibrary.simpleMessage("クラシックホーム"),
    "classicLine": MessageLookupByLibrary.simpleMessage("回線："),
    "classicNoLine": MessageLookupByLibrary.simpleMessage("プロキシを選択"),
    "classicPermanent": MessageLookupByLibrary.simpleMessage("永久利用権を取得"),
    "classicPurchaseInfo": MessageLookupByLibrary.simpleMessage(
      "従来の外観を再現した項目です。購入サービスには接続しておらず、課金はありません。プロファイルでご自身の購読を追加してください。",
    ),
    "classicRulesLine": MessageLookupByLibrary.simpleMessage("ルールに従う"),
    "classicYoutube": MessageLookupByLibrary.simpleMessage("Youtube公式サイト"),
