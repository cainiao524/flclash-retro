...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "classicChange": MessageLookupByLibrary.simpleMessage("Change"),
    "classicGoogle": MessageLookupByLibrary.simpleMessage("Google website"),
    "classicHome": MessageLookupByLibrary.simpleMessage("Classic home"),
    "classicLine": MessageLookupByLibrary.simpleMessage("Line:"),
    "classicNoLine": MessageLookupByLibrary.simpleMessage("Select a proxy"),
    "classicPermanent": MessageLookupByLibrary.simpleMessage(
      "Get permanent access",
    ),
    "classicPurchaseInfo": MessageLookupByLibrary.simpleMessage(
      "This entry is retained for the classic layout. The original purchase service is not connected and no payment will be taken. Import your own subscription in Profiles.",
    ),
    "classicRulesLine": MessageLookupByLibrary.simpleMessage(
      "According to rules",
    ),
    "classicYoutube": MessageLookupByLibrary.simpleMessage("Youtube website"),
