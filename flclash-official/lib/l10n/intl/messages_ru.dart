...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "classicChange": MessageLookupByLibrary.simpleMessage("Сменить"),
    "classicGoogle": MessageLookupByLibrary.simpleMessage("Сайт Google"),
    "classicHome": MessageLookupByLibrary.simpleMessage("Классическая главная"),
    "classicLine": MessageLookupByLibrary.simpleMessage("Линия:"),
    "classicNoLine": MessageLookupByLibrary.simpleMessage("Выберите прокси"),
    "classicPermanent": MessageLookupByLibrary.simpleMessage(
      "Постоянный доступ",
    ),
    "classicPurchaseInfo": MessageLookupByLibrary.simpleMessage(
      "Элемент сохранён для классического вида. Сервис покупки не подключён, оплата не взимается. Добавьте свою подписку в профилях.",
    ),
    "classicRulesLine": MessageLookupByLibrary.simpleMessage("По правилам"),
    "classicYoutube": MessageLookupByLibrary.simpleMessage("Сайт Youtube"),
